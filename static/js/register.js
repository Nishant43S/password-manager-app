...
function validateForm() {
    ...
    var CpasswordInput = document.getElementById('CpasswordInput').value;
    ...
    if (!email.endsWith("@gmail.com")) {
        emailError.textContent = "must be gmail.com";
        valid = false;
    }

    // Password validation: minimum 6 characters
    if (password.length < 6) {
        passwordError.textContent = "at least 6 characters long";
        valid = false;
    }

    if (CpasswordInput !== password){
        CpasswordError.textContent = "password doesnot match";
        valid = false;
    }
